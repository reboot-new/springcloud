...
public class EnumHelper {
    ...
    public static <T> Object getEnumDescriotionByValue(Object value,
        ...
        String valueMathod = "getType";    //默认获取枚举value方法，与接口方法一致
        String desMathod = "getName"; //默认获取枚举description方法
...
//        c=key,获取对应的描述
//        EnumUtil.getEnumDescriotionByValue(c,WaresTypeEnum.class,"getId","getName").toString();
    }
}